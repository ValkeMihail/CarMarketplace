...
import { Car } from '.././SellPage/Sell';
import { AuthContext } from '../../AuthContext';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faArrowLeft, faArrowRight, faEuroSign, faExpand, faHeart, faLocationDot, faMessage, faXmark } from '@fortawesome/free-solid-svg-icons';
import { showToolTip } from '../Navigation/Footer';
import { createChat } from '../../Helpers';

import {getDoc,doc,db, getDocs, collection, arrayRemove, updateDoc,auth, arrayUnion} from '../../firebase';


/**
 * @description Car Ad page component
 * @returns  the JSX code which represents the Car Ad page component that contains the car ad details .
 */
export const CarAd = () => {
    ...
    /**
     * @description This function is used to navigate to the chat page with the `recepientId` and create a new chat if it doesn't exist
     * @param recipientId the id of the user that will receive the message
     */ 
    const messageUser = async(recipientId: string) => {
        const chatId : string = await createChat(recipientId, `${window.location.origin}/ad/${carID}`, carAd?.images[0]);
            if(chatId != ""){
    ...
    useEffect(() => {
        ...
        const getCarFromDB = async () => {
          ...
          if (carDoc.exists()) {
            ...
            // Add new properties to the car object
      ...
      /**
       * @description This function is used to check if the current car ad is in the user's favourite ads
       * @param carID  the id of the car ad
       * @returns  true if the car ad is in the user's favourite ads , false otherwise
       */
    ...
    /**
     * @description This function is used to add or remove the current car ad to/from the user's favourite ads
     * @param carID  the id of the car ad
     */
    ...
    /**
     * @description This function is used to get the user's photo from the database
    ...
    /**
     * @description This function is used set the current slide to the previous slide by decreasing the current slide index by 1
     */
    const prevSlide = () => {
    ...
    /**
     * @description This function is used set the current slide to the next slide by increasing the current slide index by 1
     */ 
    const nextSlide = () => {
    ...
    /**
     * @description This function is used to set the transform property of a slide based on the index
     */ 
            ...
            <div className="container">
                <div className="adContainer">
                    <div 
                        ...
                        className={isfullScreen ? "imageContainer fullScreenImageCont" : "imageContainer"}>
                    ...
                    <div className="ad">
                        ...
                        <div className="userDisplay">
                            ...
                            <div    
                                 onClick={() => navigate(`/user/${carAd.userID}`, {state: {userID:carAd.userID}})}
                                ...
                                <div className="adButtons">
                                    <div  
                                        ...
                                        <FontAwesomeIcon icon={faHeart}
                                            className={isFavourite(carAd?.id) ? "fontAwesomeRed" : "fontAwesomeIcon"}/>
                                    </div>
                        ...
                        <div className="AdDetails">
                            ...
                            <div className="grid-item">
                                <p>{carAd?.fuelType == "electric" ? "Battery Capacity": "Cilinder Capacity"}</p>
                        ...
                        <div className="optionalInfo">
                            ...
                            <div className="optionalInfoItem">
                                ...
                                <p>
                                    {carAd?.dayOfFirstRegistration}
                                </p>
                                <p>/</p>
                                <p>
                                    {carAd?.monthOfFirstRegistration}
                                </p>
                                <p>/</p>
                                <p>
                                    {carAd?.yearOfFirstRegistration}
                                </p>
                            </div>
                            <div className="optionalInfoItem">
                                <p>Video Link:</p>
                        ...
                        <div className="otherInfo">
                            ...
                            <div className="dateWrap">
                                <h5>
                                    {carAd?.createdAt.toDate().toLocaleDateString()}
                                </h5>
                            </div>
                        </div>
                    </div>
