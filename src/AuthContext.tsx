...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    /**
     * Sign in with Google using GoogleAuthProvider with a popup.
     */
    ...
    const uploadPhotoFile = async (file : File) => {
        ...
        const storageRef = ref(storage, `users/${auth.currentUser!.uid}/profilePicture.jpg`);
    ...
    const setUserRegistered = (data : Partial<User>) => {
        setRegisteredUser((prevState) => ({ ...prevState!, ...data }));

    }
    

    return (
      <AuthContext.Provider value={{ user,setUserRegistered,isProviderGoogle, setUSER, isUserVerified, uploadPhotoFile,createUserWithEmailAndPasswordHandler, updateUserDoc, signInWithGoogle,sendVerificationEmail, signInWithEmailAndPasswordHandler, signOut: handleSignOut }}>
        {children}
