...
const Explore = () => {
    ...
    useEffect(() => {
        ...
        /**
         * This function gets the counts of the cars and users from the database and sets the countCars and countUsers states to the counts
         */
        ...
        /**
         * This function gets the users from the database and sets the users state to the users
         */
        const getUsers = async () => {
            const usersColRef = collection(db, "users");
            const usersQuery = query(usersColRef, orderBy("createdAt", "desc"), limit(4));
    ...
    return (
        ...
        <div className="container">
            ...
            <div>
                ...
                <p>
                    Our top car dealers are carefully selected based on a range of factors, including how much time they have been members and overall reputation within the industry. By showcasing our top car dealers, we provide buyers with a curated selection of high-quality cars and a streamlined way to find the right dealer for their needs.
                </p>
                <div className="stats">
                    <div>
